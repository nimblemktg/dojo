...
<div id="rv_add_to_cart_redirect_product_data_tab" class="panel woocommerce_options_panel">
	...
	<?php
		...
		$args = array(
			'id' => $key,
			'label' => __( 'Add-to-Cart Redirect URL', RV_CUSTOM_WC_REDIRECTS_TEXT_DOMAIN ),
			'placeholder' => 'https://',
			'wrapper_class' => 'hide_if_external',
			'default' => '',
			'desc_tip' => 'true',
			'description' => __( 'This is where the user will be redirected to after this product is added to the cart. Enter a full URL.', RV_CUSTOM_WC_REDIRECTS_TEXT_DOMAIN ) ,
