 ...
 */
function orbisius_ct_dojo_trade_show_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_dojo_trade_show_parent_style';
    $parent_base_dir = 'givingwalk';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_dojo_trade_show_child_theme_enqueue_styles' );
