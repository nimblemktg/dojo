...
if( ! class_exists( 'EF3MegaMenuFramework' ) ) {
	...
	class EF3MegaMenuFramework {
		...
		function __construct() {
			...
			if(!isset($opt_theme_options['opt_enable_mega_menu']) || !$opt_theme_options['opt_enable_mega_menu'])
				return;
...
add_action('init', 'givingwalk_mega_menu', 5);

function givingwalk_mega_menu(){
