...
function register_flickr_widget() {
    register_ef4_widget('givingwalk_Flickr_Widget');
}

class givingwalk_Flickr_Widget extends WP_Widget {
	function __construct() {
        parent::__construct(
            'givingwalk_flickr_widget', // Base ID
            esc_html__('Givingwalk Flickr', 'givingwalk'), // Name
            array('description' => esc_html__('A widget that displays Flickr photos.', 'givingwalk'),) // Args
        );
    }
    ...
    function widget( $args, $instance ) {
        ...
        <?php if (!empty($instance['stream_url'])) : ?>
	        	<span class="flickr-brand"><a href="<?php echo esc_url($instance['stream_url']); ?>" target="_blank"><?php esc_html_e('View stream on flickr', 'givingwalk'); ?></a></span>
	        <?php endif; ?>
		<?php
	...
	function form( $instance ) {
		...
		<p>
            <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e('Description:', 'givingwalk'); ?></label>
		...
		<p>
            <label for="<?php echo esc_attr($this->get_field_id( 'flickr_id' )); ?>"><?php esc_html_e('Flickr ID:', 'givingwalk'); ?></label>
            ...
            <br /><span class="helper"><?php esc_html_e('Look your ID here,', 'givingwalk'); ?> <a href="<?php echo esc_url($flirck_url); ?>" target="_blank">idGettr</a>.</span>
        </p>
		...
		<p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>">
               <?php esc_html_e('Number of Photos:', 'givingwalk'); ?>
            </label>
                ...
                <br /><span class="helper"><?php esc_html_e('Up to 10 photos allowed.', 'givingwalk'); ?></span>
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'stream_url' )); ?>"><?php esc_html_e('Stream url:', 'givingwalk'); ?></label>
