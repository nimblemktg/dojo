...
class givingwalk_StaticCss
{
    ...
    public function css_render()
    {
        ...
        $logo_w                = '223px';
        $dropdown_mobile_bg    = 'rgba(0,0,0,1)';
        ...
        $options_map = [
            ...
            'body_font_family'                => ['opt_font_body.font-family', 'Lato'],
            'body_font_color'                 => ['opt_font_body.color', '#666'],
            'body_font_size'                  => ['opt_font_body.font-size', '15px'],
