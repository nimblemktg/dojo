...
vc_map(
	array(
		'name'     => esc_html__('Red Story Carousel', 'givingwalk'),
		'base'     => 'red_story_carousel',
		...
		'params'   => array(
	    	array(
				...
				'settings' => array(
					...
					'delay' => 500,
					'auto_focus' => true,
					'values'   =>  givingwalk_get_story_categories_for_autocomplete(),
				),
...
class WPBakeryShortCode_red_story_carousel extends CmsShortCode{
