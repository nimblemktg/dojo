    ...
    <div>
        ...
        <div class="causes-form-wrap view-single active view-initial" data-name="donor-info" data-group="payment-info">
            <div class="dynamic-data" data-target="items"
                 data-template="<?php echo esc_attr($event_info_template) ?>"></div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="dynamic-data" data-target="special:sample_amount"
                             data-template="<?php echo esc_attr($sample_amount_template) ?>">
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="dynamic-data" data-target="group"
                             data-template="<?php echo esc_attr($input_amount_template) ?>"></div>
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="action-row text-center">
                <button class="btn btn-submit"
                        type="submit"><?php echo esc_html__('Process', 'givingwalk'); ?></button>
            </div>
        </div>
    </div>
</div>
